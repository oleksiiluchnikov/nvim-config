...
The `cmd_runner` is a CodeCompanion tool that allows the AI assistant to execute shell commands on your system. It runs commands in your current working directory: `~/.config/nvim`
