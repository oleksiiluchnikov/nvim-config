-- Options alternatives (extracted from config/options.lua)
-- These are LazyVim-era options that may be useful to pull back.
-- To use any of these, copy them back to config/options.lua.
