...
local function get_os_info()
    ...
    elseif os_name == 'Darwin' then
        local version =
            safe_system_cmd('sw_vers -productVersion', 'Unknown Version')
        return 'macOS ' .. version
    elseif os_name == 'Windows_NT' then
        local version = safe_system_cmd(
...
Before making any file changes, remember these:
- Git commit before large changes
- Test after finished patch
- Git commit working state
- Use CLAUDE.md, DEVELOPMENT.md, CONTRIBUTING.md, README.md, and other docs to read, store, and recall project conventions and guidelines.
- Commit to CHANGELOG.md as simple bullet points after significant changes.
