...
return {
    ...
    handlers = {
        ...
        inline_output = function(self, data, context)
            if self.opts.stream then
                return log:error(
                    'Inline output is not supported for non-streaming models'
                )
            end
        ...
        tools = {
            ...
            output_response = function(self, tool_call, output)
                local formatted_content = vim.trim(output)
                    :gsub('\n{3,}', '\n\n')
                return {
        ...
        model = {
            ...
            choices = {
                ['moonshotai/kimi-k2:free'] = {
                    formatted_name = 'Kimi K2 (free)',
                    opts = { has_vision = true, can_reason = true },
                },
                ['openrouter/sherlock-dash-alpha'] = {
                    formatted_name = 'Sherlock Dash Alpha (free)',
                    opts = { has_vision = true, can_reason = true },
                },
                ['openrouter/sherlock-think-alpha'] = {
                    formatted_name = 'Sherlock Think Alpha (free)',
                    opts = { has_vision = true, can_reason = true },
                },
                ['x-ai/grok-4-fast:free'] = {
                    formatted_name = 'Grok 4 Fast (free)',
                    opts = { has_vision = true, can_reason = true },
                },
                ['z-ai/glm-4.5-air:free'] = {
                    formatted_name = 'GLM 4.5 Air (free)',
                    opts = { has_vision = true, can_reason = true },
                },
